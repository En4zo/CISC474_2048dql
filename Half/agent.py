...
"""
class Agent:
    # the constructor for class Agent
    # alpha is the learning rate
    # epsilon decides the probability of exploration
    def __init__(self, alpha=5e-4, gamma=0.9, epsilon=0.9):
        self.alpha = alpha
        self.gamma = gamma
        self.epsilon = epsilon

        # the attributes for neural networks
        ...
        self.fc_layer1_weights, self.fc_layer1_biases, self.fc_layer2_weights, self.fc_layer2_biases = \
